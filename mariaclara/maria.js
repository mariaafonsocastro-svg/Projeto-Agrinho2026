...
function apoiarRegenerativa() {
    ...
    for (let i = 0; i < 130; i++) {
        setTimeout(() => {
            createFallingItem(
                confetes[Math.floor(Math.random() * confetes.length)],
                Math.random() * window.innerWidth
            );
        }, i * 7);
    }
...
const questions = [
    {
        ...
        a: [
            "Explora o solo até acabar",
            "Regenera e nutre o solo como um ser vivo",
            "Só usa produtos químicos"
        ],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        a: [
            "Arar a terra profundamente",
            "Não revolver o solo e plantar sobre a palha",
            "Usar mais máquinas"
        ],
        correct: 1
    },
    {
        ...
        a: [
            "Revolver o solo toda semana",
            "Fazer compostagem com restos orgânicos",
            "Usar muito adubo químico"
        ],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        a: [
            ...
            "Insumos químicos em larga escala",
    ...
    },
    {
        ...
        a: [
            "Libera mais carbono",
            "Captura e armazena carbono no solo",
            "Não afeta o clima"
        ],
        correct: 1
    },
    ...
    },
    {
        ...
        a: [
            ...
            "Regenerar o solo para as próximas gerações",
            "Produzir o mais barato possível"
        ],
        correct: 1
    }
];
...
function showResult() {
    ...
    document.getElementById('score').innerHTML =
        `${percentage}%<br><span class="text-2xl">acertos</span>`;
}
